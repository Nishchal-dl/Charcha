...
urlpatterns = [
    ...
    url(r'^profile/me/post/$', views.myprofile, name="myprofile"),
    ...
    url(r'^api/post/(?P<post_id>\d+)/upvote$', views.upvote_post, name="upvote_post"),
    url(r'^api/post/(?P<post_id>\d+)/downvote$', views.downvote_post, name="downvote_post"),
    url(r'^api/posts/(?P<post_id>\d+)/undovote$', views.undo_vote_on_post, name="undo_vote_on_post"),

    url(r'^api/comments/me/(?P<comment_id>\d+)/upvote$', views.upvote_comment, name="upvote_comment"),
